...
/**
  * This is an event sourced entity. It has a state, [[LagomchatState]], which
  ...
  */
class LagomchatEntity extends PersistentEntity {

  override type Command = LagomchatCommand[_]
  override type Event = LagomchatEvent
  override type State = LagomchatState

  /**
    * The initial state. This is used if there is no snapshotted state to be found.
    */
  override def initialState: LagomchatState = LagomchatState("Hello", LocalDateTime.now.toString)
  ...
  override def behavior: Behavior = {
    case LagomchatState(message, _) => Actions().onCommand[UseGreetingMessage, Done] {
      ...
      case (GreetingMessageChanged(newMessage), state) =>
        ...
        // the event.
        LagomchatState(newMessage, LocalDateTime.now().toString)
...
/**
  ...
  */
case class LagomchatState(message: String, timestamp: String)

object LagomchatState {
  /**
    ...
    */
  implicit val format: Format[LagomchatState] = Json.format
}

/**
  * This interface defines all the events that the LagomchatEntity supports.
  */
sealed trait LagomchatEvent

/**
  * An event that represents a change in greeting message.
  */
case class GreetingMessageChanged(message: String) extends LagomchatEvent
...
/**
  ...
  */
sealed trait LagomchatCommand[R] extends ReplyType[R]
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends LagomchatCommand[Done]
...
/**
  ...
  * person.
  */
case class Hello(name: String, organization: Option[String]) extends LagomchatCommand[String]
...
/**
  ...
  * application loader.
  */
object LagomchatSerializerRegistry extends JsonSerializerRegistry {
  override def serializers: Seq[JsonSerializer[_]] = Seq(
    JsonSerializer[UseGreetingMessage],
    JsonSerializer[Hello],
    JsonSerializer[GreetingMessageChanged],
    JsonSerializer[LagomchatState]
  )
}
